...
Both paths use the same WebGPU + TSL runtime. Only the UI layer differs: headless helpers from the root export, or batteries-included R3F with optional Leva and DOM labels/legends.
