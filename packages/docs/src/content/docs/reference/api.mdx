...
| `threejs-debug-view/r3f` | Batteries-included R3F layer (`DebugViewLayer`), controlled overlay (`DebugViews`), bundled Leva shell (`DebugViewLeva`, `mountDebugViewLeva`), and `useDebugViewsControls()` for custom UI. |
