...
Examples below show both the headless runtime and the R3F adapter; the same `DEFAULT_DEBUG_VIEWS` list works in either path — see [Headless Runtime](/threejs-debug-view/guides/headless-runtime/).
